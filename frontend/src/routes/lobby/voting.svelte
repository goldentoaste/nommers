<script>
    ...
    let description = 'Fast-food chain offering Mexican fare including design-your-own burritos, tacos, and bowls.';

    let totalLength = Object.keys($places).length;
    let index = 0;
    let obj;
    let socket; 
    let placeid;
    
    $: obj = Object.values($places[index])[0]
    $: placeid = Object.keys($places[index])[0]
    $: console.log(obj)
</script>

<div class="voting-content">
    <div class="exit-button">
        <a href="/home"><img src="icons/exit.svg" alt="Exit party" /> <span>Exit party</span></a>
    </div>
    ...
    <div class="loader">
        ...
        <div class="loader-information">
            <span class="caption-text">12 restaurants remaining</span>
            <span class="overline">75% completed</span>
        </div>
    </div>
...
<style>
    ...
    .restaurant-info > div > .restaurant-icon {
        width: var(--sp-xl);
        height: auto;
        aspect-ratio: 1/ 1;
    }
