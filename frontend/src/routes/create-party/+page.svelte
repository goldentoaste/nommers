<script>
    ...
    let sort="prominence", price="3", rating="1", hours=false, address="";
...
<div class="create-party">
            ...
            <div class="input-group">
                ...
                <div class="checkbox-group">
                    {#each offerings as offering}
                        <label>
                            <input type="checkbox" bind:group={selected_offerings} name="offerings" value={offering} />
                            {offering}
                        </label>
                    {/each}
                </div>
    ...
    <div class="create-party-actions">
        <div class="body-title primary-action" on:click={createParty}>Create party</div>
        <a class="body-title secondary-action" href="/home">Back to home</a>
    </div>
</div>
